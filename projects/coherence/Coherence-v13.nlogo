...
to tidy-up
  ...
  if movie-every > 0 [
    movie-close
    export-all-plots word title ".csv"
  ]
end
...
to-report candidate-drop
  ...
  let oth-list sort-by [first ?1 < first ?2] map [list coherency-with ? ?] [self] of my-neighbors
  ...
  if change-link-on = "most incoherent" [
    ifelse not empty? oth-list
      [report link-from second rnd:weighted-one-of oth-list [first ?]]
      [report nobody]
  ]
...
to add-link
   let newoth nobody
   if add-fof-first? [set newoth one-of fof-cand-nodes]
...
to calc-stats
  ...
  set prop-consensus consensus / num-agents

  set pi-l calc-het-l
  set pi-a calc-het-a
  set pi-t calc-het-t
  set het-prop calc-hetero
  set prop-l-consensus calc-cons

  set av-num-links count links / count turtles
  set glob-clustering global-clustering-coefficient
end
...
1. Install Netlogo (version 5.2 onwards)
1. Install the following Netlogo extensions: table, array, nw, & rnd (see http://ccl.northwestern.edu/netlogo/docs/extensions.html for instructions to do this)
...
@#$#@#$#@
<experiments>
  <experiment name="eg base" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="add-fof-first?">
      <value value="true"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="prob-drop-link">
      <value value="0.3"/>
    </enumeratedValueSet>
  ...
  <experiment name="new base - 0.5 variants" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="new base 0.5 -y-b b-y - bels links" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="new base 0.5 by yb - bels links" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="new base - minorities" repetitions="20" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="2000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="eg base" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="title">
      <value value="&quot;minority-med-0.25-no link ch&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="eg options" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="eg options by" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="3 base examples" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>drop-rate</metric>
  ...
  <experiment name="3 base examples 1000" repetitions="1000" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>drop-rate</metric>
